...
class BinarySearchTree:
    ...
    def breadth_first_search_recursive(self, back_link_queue, bfs_list):
        if len(bfs_list) == self.length:
            return bfs_list

        current_node = back_link_queue[0]
        back_link_queue.remove(back_link_queue[0])
        ...
        return self.breadth_first_search_recursive(back_link_queue, bfs_list)
